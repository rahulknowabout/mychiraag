                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Discount(%)" type="text" class="form-control col-md-7 col-xs-12" required="required" id="discount" name="discount" data-parsley-id="3686" value="<?php echo $discount; ?>">
                                            </div>
                                        </div>
