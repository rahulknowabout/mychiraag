...
$allSet = $ketObj->runquery("SELECT", "id,userid,DATE(order_time_stamp),grossamount,discount,oaddress,status,pack_staff,del_staff,dis_method","ketechord_".$_REQUEST['vid'], array(),$where );
