...
function chkAlias()
{
	...
	if(/^[a-zA-Z0-9-&]*$/.test(palias) == false) {
		alert('Alias  can contain hyphen(-)!');
		return false;
	}
	$.ajax( {
			url: "index.php",
...
if( isset( $_REQUEST['del'] ) && $_REQUEST['del'] > 0 )
	{
		...
		header("Location:index.php?v=shopp&vid=".$vid."&productCat=".$productCat."&searchbyproduct=".$searchbyproduct."&searchp=".$searchp."&buscatid=".$buscatidS."");
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div id="wizard" class="form_wizard wizard_horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                             ...
                                             <?php if( isset( $allSetC ) && count( $allSetC  ) >0 ){  ?>
										              <input type="hidden" name="pide" value="<?php echo $pcategory; ?>"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div data-toggle="buttons" class="btn-group" id="cstatus">
                                                    <label data-toggle-passive-class="btn-default" data-toggle-class="btn-primary" class="btn btn-default parsley-success <?php if( isset($pstatus ) && $pstatus == 0 ){ echo "active";} ?>">
                                                    ...
                                                    <label data-toggle-passive-class="btn-default" data-toggle-class="btn-primary" class="btn btn-primary  <?php if( isset($pstatus ) && $pstatus == 1 ){ echo "active";} ?>">
                                        ...
                                        <div id="step-3">
                                            <div class="form-group">
                                            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">Image
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Main Image" type="file" class="form-control col-md-7 col-xs-12" id="prodmainimg" name="prodmainimg" data-parsley-id="3686" value=""><?php echo $_SESSION['config']['prod_full_w']." x ".$_SESSION['config']['prod_full_h']; ?>
                                            </div>
                                        </div>
										<!--<div class="form-group">
