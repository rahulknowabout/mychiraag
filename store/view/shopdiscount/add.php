...
function firstshop( str )
{
//alert(str);
	//discount_on	    =	document.getElementById('discont_on').value;
	if( str == "first_time_shopping" )
	{
		document.getElementById("firstshop").style.display ="block";
		document.getElementById("mxdl").style.display ="block";
	}else { document.getElementById("firstshop").style.display ="none"; 
			document.getElementById("mxdl").style.display ="none";
...
if( isset( $allSet ) && is_array( $allSet ) && count( $allSet ) > 0 )
{
	...
	$hmt = $allSet[0]['hmt'];
	$max_discount = $allSet[0]['max_discount'];
	$pcategory   =     "";
                                    ...
                                    <br>
									 ...
									 <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <select name="discount_on" id = "discount_on"  onchange = "showbox(this.value)" class="form-control">
										 ...
										 <div class="form-group" id = "catdiv" <?php if( isset( $allSet[0]['buscat'] ) && $allSet[0]['buscat']!="" ){}else{ echo 'style="display:none"'; } ?>>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <select name="productCat" onchange="CatAjax(this.value,'p')" class="form-control">
										...
										<div class="form-group" id = "amtdiv"  <?php if( $amt != "" ){}else{echo 'style="display:none"';}?>>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Amount" type="text" class="form-control col-md-7 col-xs-12"  id="amt" name="amt" data-parsley-id="3686" value="<?php echo $amt; ?>">
                                            </div>
                                        </div>
										<div class="form-group" id = "dis_type123" <?php if( isset( $discount_type ) && $discount_type != ""){}else{echo "style='display:none;'";} ?>>
										 ...
										 <div class="form-group" <?php if( $discount_type == "first_time_shopping"){ ?><?php } else { ?>style="display:none"<?php } ?> id = "firstshop">
                                            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">Number of Time Use<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Number of Time Use" type="text" class="form-control col-md-7 col-xs-12" id="hmt" name="hmt" data-parsley-id="3686" value="<?php echo $hmt; ?>">
                                            </div>
                                        </div>
										<div class="form-group" <?php if( $discount_type == "first_time_shopping"){ ?><?php } else { ?>style="display:none"<?php } ?> id = "mxdl">
                                            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">Max Discount Limit<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Max Discount Limit" type="number" class="form-control col-md-7 col-xs-12"  id="mxd" name="mxd" data-parsley-id="3686" value="<?php echo $max_discount; ?>" min="0">
                                            </div>
                                        </div>
