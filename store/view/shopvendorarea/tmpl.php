...
$Count = $ketObj->runquery( "SELECT", "count(*)", "ketechvendorarea", array(), ""  );
$hold = $Count['0']['count(*)']; 
$counter = 1; 
$where = "";
$searchbyorder = "";
...
{
	$where = " where area_name like '%".$_REQUEST['searchbyorder']."%'";
...
if(isset($_GET['vid']) && $_GET['vid']!="") {
	...
	$counter= $vid1+1;
	$vid1 = ($_GET['vid']-1)*10;
	$allCat = $ketObj->runquery( "SELECT", "*", "ketechvendorarea", array(), $where." limit ".$vid1.",10"  );
	//$rowe = runquery("SELECT","*","artical","","".$where."limit ".$vid1.",10");
    //$count= $vid1+1;
	}
else {
	$allCat = $ketObj->runquery( "SELECT", "*", "ketechvendorarea", array(), $where." limit 0,10"  );
                        ...
                        <div class="title_right">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                <div class="input-group">
									...
									<input type="hidden" class="form-control" placeholder="Search for..." name = "v" value="shopvendorarea">
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        <li><a href="index.php?v=shopvendorarea&f=add">Add New</a>
                                        ...
                                        <tbody>
											...
											?>
														<tr>
															...
															<td><?php echo $allCatV['area_name']; ?></td>
														
															
                                                            <td><a href = "index.php?v=shopvendorarea&f=add&cid=<?php echo $allCatV['id'];?>" class="btn btn-info">Edit</a></td>
                                                            <td><a href = "index.php?v=shopvendorarea&f=add&del=<?php echo $allCatV['id'];?>" class="btn btn-danger">Delete</a></td>
														</tr>
											<?php			
														$counter++;
													}
													
													$path = 'index.php?v=shopvendorarea';
													if( isset( $_REQUEST['searchbyorder'] ) && $_REQUEST['searchbyorder'] != "" ){
														$path = 'index.php?v=shopvendorarea&searchbyorder='.$_REQUEST['searchbyorder'].'';
													}
