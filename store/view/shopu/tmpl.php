...
{
	$where = " where uname like '%".$_REQUEST['searchbyorder']."%' OR urole like '%".$_REQUEST['searchbyorder']."%' ";
}else{
		$where = " where urole <> 'vendor' ";
}
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Results </h2>
                                        ...
                                        <li><a href="index.php?v=shopu&f=add">Add New</a></li>
                                    </ul>
                                        ...
                                        <tbody>
											...
											?>
														<tr>
                                                            ...
                                                            <td><a href = "index.php?v=shopu&f=add&uid=<?php echo $allUserV['id'];?>&vid=<?php if( isset( $_REQUEST['vid'] ) && $_REQUEST['vid']>0){ echo $_REQUEST['vid'];}else{ echo "";} ?>" class="btn btn-info">Edit</a></td>
                                                            <td><a href = "index.php?v=shopu&f=add&del=<?php echo $allUserV['id'];?>&vid=<?php if( isset( $_REQUEST['vid'] ) && $_REQUEST['vid']>0){ echo $_REQUEST['vid'];}else{ echo "";} ?>" class="btn btn-danger">Delete</a></td>
