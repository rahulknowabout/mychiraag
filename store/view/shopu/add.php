...

{
	...
	uemail	=	document.getElementById('uphone').value;
	...
	$.ajax( {
			...
			data: "aj=y&uid="+uid+"&chk=uvemail&vemail="+uemail,
...
if( isset( $_REQUEST['del'] ) && $_REQUEST['del'] > 0 )

	{
		...
		header("Location: index.php?v=shopu&vid=".$vid."");
...
<div class="right_col" role="main">
									...
									<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input placeholder="User Phone" type="number" class="form-control col-md-7 col-xs-12" required="required" id="uphone" name="uphone" data-parsley-id="3686" value="<?php echo $uphone; ?>" min="0">
                                            ...
                                            <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">Role<span class="required">*</span>
											 ...
											 <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <select class="select2_single form-control" tabindex="-1" name="urole">
													...
													<option value="user"<?php if( $urole == "user") { echo 'selected = "selected"';} ?>>User</option>
                                                    ...
                                                    <!--<option value="vendor"<?php if( $urole == "vendor") { echo 'selected = "selected"';} ?>>Vendor</option>-->
	...
	<?php if( isset( $_REQUEST['vid'] ) && $_REQUEST['vid'] > 0 ){ ?>
