                                ...
                                <div class="x_content">
                                    ...
                                    <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Category Image" type="file" class="form-control col-md-7 col-xs-12" id="catthumbimg" name="catthumbimg" data-parsley-id="3686" value="">
                                            </div>
                                        </div>
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Category Image" type="file" class="form-control col-md-7 col-xs-12" id="catimg" name="catimg" data-parsley-id="3686" value="">
                                            </div>
                                        </div>
										<div class="form-group">
