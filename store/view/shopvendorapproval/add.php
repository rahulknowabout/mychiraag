                                    ...
                                    <br>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Minimum Purchasing Amount" type="text" class="form-control col-md-7 col-xs-12" required="required" id="minpa" name="minpa" data-parsley-id="3686" value="<?php echo $minpa; ?>">
                                            </div>
                                        </div>
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Maximum Purchasing Amount" type="text" class="form-control col-md-7 col-xs-12" required="required" id="maxpa" name="maxpa" data-parsley-id="3686" value="<?php echo $maxpa; ?>">
                                            </div>
                                        </div>
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="Shipping Charges" type="text" class="form-control col-md-7 col-xs-12" required="required" id="shipping_charges" name="shipping_charges" data-parsley-id="3686" value="<?php echo $shipping_charges; ?>">
                                            </div>
                                        </div>
