...
if( isset( $_REQUEST['del'] ) && $_REQUEST['del'] > 0 )

	{
		...
		header("Location: index.php?v=shopc&vid=".$vid."&productCat=".$productCat."&searchbyproduct=".$searchbyproduct."&searchp=".$searchp."");
...
*/$allCat = $ketObj->runquery( "SELECT", "id,cname,calias", "ketechcat", array(), " WHERE cparent < 1"  );
                                    ...
                                    <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input placeholder="Category Image" type="file" class="form-control col-md-7 col-xs-12" id="catthumbimg" name="catthumbimg" data-parsley-id="3686" value=""><?php echo $_SESSION['config']['cat_full_w']." x ".$_SESSION['config']['cat_full_h']; ?>
